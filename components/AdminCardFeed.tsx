...
<div className="flex flex-row content-center ... max-w-[40%] min-w-[35%]">
   ...
   {job.logo ? <Image src = {job.logo} className = "mr-3 my-auto rounded"  alt = 'Company logo' width = '56' height = '56' /> : 
  ...
  <div className="justify-start text-left">  
    ...
    <div className="flex items-center gap-3 mt-2">
        ...
        {job.tags.map((tag: string | number, index) => (
            ...
            <div key = {index} className="flex justify-center items-center m-1 font-medium py-1 px-2 rounded-full text-stone-700 bg-orange-300 border border-orange-300 ">
